...
sasort.idl
	...
	first MIDL.EXE to generate sasort.tlb, and then tlb2h.exe to generate a header file
	called CometExampleSaSort.h.
	
	Note that MIDL is _only_ used to generate the type library file "sasort.tlb".
...
sasort.rc
	...
	sasort.idl - so you will have to build the project once (and generate
...
std.h, std.cpp
    ...
    named sasort.pch and a precompiled types file named std.obj.
