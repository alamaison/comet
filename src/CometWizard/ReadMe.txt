========================================================================
                    CUSTOM APPWIZARD: comet
========================================================================


AppWizard has created a comet DLL for you.  This DLL is the starting point
...
you build comet.awx, it will automatically be copied to your Template
...
cometAw.h, cometAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CCometAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into comet.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "J:\lambdasoft\Projects\comet\Server\Server.dsp".
...
off of the project "J:\lambdasoft\Projects\comet\Server\Server.dsp".
